...
ALTER TABLE Message RENAME COLUMN "User_user_uuid" TO "user_uuid";
ALTER TABLE Message RENAME COLUMN "message_sentAt" TO "message_sentat";
...
ALTER TABLE user RENAME COLUMN "user_createdAt" TO "user_createdat";